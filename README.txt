...
'dust1' = Thermal dust: Thermal dust is modelled as a single-component modified 
 ...
 available 2048 product degraded to nside 512.  The polarization templates have had small
 scales added by the procedure described in the accompanying paper.

'synchrotron1' = Synchrotron:  A power law scaling is used for the synchrotron emission, with
 a spatially varying spectral index.  The emission templates are the Haslam 408 MHz data 
 reprocessed by Remazeilles et al 2015 MNRAS 451, 4311, and the WMAP 9-year 23 GHz Q/U maps 
 (Bennett, C.L., et.al., 2014, ApJS, 208, 20B), These maps have had small scales added by 
 the procedures outlined in the accompanying paper.
 ...
 model is also supported with a single isotropic curvature index. The size of this curvature
 is taken from Kogut, A. 2012, ApJ, 753, 110.  
...
'synchrotron3' = a power law with a curved index. The model uses the same index map as 
 the nominal model, plus a curvature term.  We use the best-fit curvature amplitude 0f
